...
public class LanguageCodeHelper {
    ...
    private static final String TAG = "LanguageCodeHelper";
    private Context appContext;

    public LanguageCodeHelper(Context appContext) {
	 ...
	 */
	public String getOcrLanguageName(String languageCode) {
   ...
   * "Spanish"
	 ...
	 */
	public String getTranslationLanguageName(String languageCode) {
    Resources res = appContext.getResources();
